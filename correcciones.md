...
- **Pasando el mouse por el mosaico** la baldosa se agranda y se queda quieta mientras la estés mirando (no se regenera). Si barrés con el mouse se agrandan varias, porque tardan en volver a su tamaño. **Un click en una baldosa le genera un símbolo nuevo.**
...
- **Generás al azar con el botón o con la tecla G,** y salen **ocho familias de figuras**: flor, demonio (cara con cuernos y colmillos), mandala, abstracto, trama, calavera, animal y orgánico. **Salen más seguido las flores, los demonios y los abstractos**, que son las que mejor quedan.
